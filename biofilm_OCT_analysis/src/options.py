...
The reason these are global is to avoid passing a context everywhere
'''
...
class Option:
    def __init__(self, info : dict[str, any]):
        ...
        self._check_exists : bool | None = None
        self._require_above_mode : int | None = None
        self._extension : str | None = None
        self._nullable : bool | None = None
        self._typ : type = _string_to_type(info['type'])
